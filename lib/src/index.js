...
var DialogNode_1 = require("./models/DialogNode");
var DialogResponse_1 = require("./models/DialogResponse");
var DialogCondition_1 = require("./models/DialogCondition");
exports.Models = {
    Character: Character_1.Character,
    Dialog: Dialog_1.Dialog,
    DialogNode: DialogNode_1.DialogNode,
    DialogResponse: DialogResponse_1.DialogResponse,
    DialogCondition: DialogCondition_1.DialogCondition,
};
var DEFAULT_CONFIG = {
    reconnect: false,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('[PG] Connection error', error_1);
                    setTimeout(function () {
